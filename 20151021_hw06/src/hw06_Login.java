...
public class hw06_Login extends JFrame implements ActionListener {
	public hw06_Login(){
		initComp();
	}
	...
	private JTextField jtfAcc = new JTextField("1234");
	private JPasswordField jpfPass = new JPasswordField("1234");
	...
	private void initComp(){
		...
		jbtnEnter.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae){
				...
				if(sAcc.equals("1234") && sPass.equals("1234")){
					hw06_Frame jframe = new hw06_Frame();
					setVisible(false);
				}
			}
		});
